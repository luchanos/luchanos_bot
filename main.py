...
**2️⃣ Основные принципы ООП**
  - Инкапсуляция: сокрытие данных и поведения.
...
A: Ориентировочно 5 занятий, но их может быть больше - все будет зависеть от темпа. Моя задача, чтобы КАЖДЫЙ ушел с воркшопа с глубоким пониманием основ ООП в Python.
...
A: Оставьте заявку и вам будет отправлена ссылка на оплату, после чего вас добавят в группу.
